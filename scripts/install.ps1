...
param(
    ...
    # Directory in which to place backup files.
    [string]$BackupDir,

    # Apply to every discovered/configured settings file.
    [switch]$All,

    # Show the intended change without writing a backup or settings file.
    [switch]$DryRun,
